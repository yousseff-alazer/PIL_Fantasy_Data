...
namespace PIL_Fantasy_Data_Integration.API.Controllers
{
    ...
    public class PlayerMatchStatsController : ControllerBase
    {
        ...
        public PlayerMatchStatsController(fantasy_dataContext context)
        {
            _context = context;
        }

        // GET: api/PlayerMatchStats
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PlayerMatchStat>>> GetPlayerMatchStats()
        {
            return await _context.PlayerMatchStats.ToListAsync();
        }
    }
}
